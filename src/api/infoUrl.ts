...
export const categoryTree_api = (data: any) => {
    return get('/hipp/public/hospital/category/tree', data)
}
...
export const categoryList_api = (data: any) => {
    return get('/hipp/public/hospital/category/list', data)
}
...
export const editList_api = (data: any) => {
    return get('/hipp/public/hospital/post/list', data)
}
...
export const editDetail_api = (data: any) => {
    return get('/hipp/public/hospital/post/detail', data)
}
